  ...
  <body style="font-family: 'Muli'">
    ...
    <div class="img-responsive img-center imagem" style="background: url('img/fundo_1.jpg');">
      <div class="container-fluid text-center justify-content-center imagem-escura">
        ...
        <div class="row">
          ...
          <div class="col-8 texto-secao1 secao1">
            Por 1 hora, 1 tarde, 1 dia:
            <br>
            sua nova forma de alugar espaços produtivos sob demanda
            <br>
          </div>
          <div class="col-2">
          </div>
    ...
    <div class="container-fluid justify-content-center">
      ...
      <div class="row secao2">
        ...
        <div class="col-8 titulo-secao3 text-center">
          Texto das ultimas Locações
        </div>
        <div class="col-2">
        </div>
      </div>
          ...
          <div class="row">
            <div class="col mx-2" style="background: url('img/item.png')" onClick="window.open( 'https://www.google.com.br','_blank' ); return false;">
              ...
              <p class="text-center" style="background-color: white;">
                <img class="rounded-circle" src="img/usuario.jpg" style="height: 60px">
                <br>
                <a class="h6" style="color: grey;">Nome do item<br> São Paulo, SP</a>
              </p>
            </div>
            <div class="col mx-2" style="background: url('img/item.png')">
              <p style="margin-top: 65%; background-color: #FFCE00; margin-right: 40%; padding-left: 5%">
              <a class="h6" style="color: #AD8A00">A partir de:</a>
              <br>
              <a class="h2">R$ 500</a>
